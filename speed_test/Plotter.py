...
class Plotter:
    ...
    def spatial_distribution(self, proj=ccrs.PlateCarree(), extent='auto', time_slice=0, chunk_size=10000):
        ...
        def get_most_freq_labels(this_ds):
            ...
            this_ds = this_ds.chunk({"N_OBS":chunk_size})
        ...
        dsp[var_name] = dsp[var_name].transpose(self.coords_dict.get('latitude'),
    ...
    def temporal_distribution(self, time_bins, start_month=0):
        ...
        # data to be plot
        pcm_labels = self.ds['PCM_LABELS'].load()
        kmap = self.m.plot.cmap(name=self.cmap_name)
